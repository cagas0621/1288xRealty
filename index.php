			...
			<div class="col-12 col-md-6 col-xl-6">
				<div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="100ms">
					...
					<div class="property-content">
						<h5>Harper</h5>
						<p class="location"><img src="<?php bloginfo('template_directory'); ?>/assets/img/icons/location.png" alt="">Calamba, Philippines</p>
						...
						<div class="property-meta-data d-flex align-items-end justify-content-between">
							<div class="bathroom">
								<img src="<?php bloginfo('template_directory'); ?>/assets/img/icons/bathtub.png" alt="">
								<span>9.5</span>
							</div>
							<div class="garage">
								<img src="<?php bloginfo('template_directory'); ?>/assets/img/icons/bed.png" alt="">
								<span>9</span>
							</div>
							<div class="space">
								<img src="<?php bloginfo('template_directory'); ?>/assets/img/icons/space.png" alt="">
